...
class ITKT_Admin {
    ...
    public function strings(){
        ...
        <div class="itkt-grid-2">
            ...
            <section class="itkt-card"><span class="itkt-kicker">THEME SCANNER</span><h2>Theme-Texte einlesen</h2><p>WoodMart und andere Themes werden über denselben generischen Scanner unterstützt. Später können Adapter zusätzliche builder-spezifische Quellen ergänzen.</p>
        ...
        <section class="itkt-card itkt-string-manager"><div class="itkt-card-head"><div><span class="itkt-kicker">STRING TRANSLATION</span><h2>Übersetzungsmanager</h2></div><span class="itkt-pill orange"><?php echo intval($result['total']);?> Treffer</span></div>
            ...
            <?php endif;?>
            <div class="itkt-notice blue"><strong>V0.8:</strong> PHP-Gettext-Strings sind aktiv. JavaScript-i18n und komplexe Pluralregeln werden später als eigener Scanner ergänzt, damit keine falschen Übersetzungen entstehen.</div>
        </section>
        <?php $this->footer();
    }
    ...
    public function settings() {
        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
            ...
            <div class="itkt-grid-2">
                ...
                <section class="itkt-card"><span class="itkt-kicker">SEO</span><h2>Mehrsprachige Suchmaschinen-URLs</h2><p>V0.7 erzeugt Canonical- und hreflang-Tags, unterstützt sprachabhängige Slugs sowie eigene SEO-Titel und Meta-Beschreibungen.</p><dl class="itkt-system-list"><div><dt>Canonical</dt><dd>Automatisch je Sprache</dd></div><div><dt>hreflang</dt><dd>Aktive veröffentlichte Sprachen</dd></div><div><dt>Yoast / Rank Math</dt><dd>Grundintegration aktiv</dd></div><div><dt>Übersetzungs-Sitemap</dt><dd><a href="<?php echo esc_url(home_url('/itkt-translations-sitemap.xml'));?>" target="_blank" rel="noopener">Öffnen ↗</a></dd></div></dl></section>
